...
impl ProcessState {
    pub fn new(module: leonardoModule, channel_state: ChannelState) -> Self {
        Self {
            module,
            channel_state,
...
#[host_functions(namespace = "leonardo")]
impl ProcessState {
    ...
    //
    // It's currently not safe to cancel a process in leonardo.
